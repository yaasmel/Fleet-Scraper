        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-accent rounded-full mb-8 animate-fade-in">
            ...
            <span className="text-sm font-medium text-accent-foreground">
              Outil de Croissance SaaS pour la Gestion de Flotte
            </span>
          </div>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6 animate-slide-up">
            Trouvez les Bons{' '}
            <span className="text-gradient">Gestionnaires de Flotte</span>{' '}
            sur LinkedIn
          </h1>

          {/* Subheadline */}
          <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto animate-slide-up" style={{ animationDelay: '0.1s' }}>
            Définissez votre audience idéale et automatisez votre prospection.
            Ciblez les décideurs de la gestion de flotte avec précision.
          </p>
          ...
          <div className="flex items-center justify-center gap-8 mt-12 text-sm text-muted-foreground animate-fade-in" style={{ animationDelay: '0.4s' }}>
            ...
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
              <span>Prêt pour Webhook</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
              <span>Compatible n8n</span>
            </div>
          </div>
        </div>
      </div>
